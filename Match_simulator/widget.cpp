...
{
    match->setDefaultTop(QPair<int, int>(third_Point.x()-10, third_Point.y()), QPair<int, int>(third_Point.x()+10, third_Point.y()), 50);
    match->setBase(QPair<int, int>(third_Point.x()-10, third_Point.y()), QPair<int, int>(third_Point.x()+10, third_Point.y()));
    match->setRandStruct();
    QPainterPath pp;
...
void Widget::drawStatic(QPainter& painter)
{
    ...
    painter.setPen(QPen(QBrush(gr), 2));
    painter.setBrush(QBrush(gr));
...
void Widget::paintEvent(QPaintEvent *)
 {
    ...
    if(third_Point.rx() - sec_Point.rx() > 5)
    {
